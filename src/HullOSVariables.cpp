...
parseOperandResult findVariable(char * name, int *position)
{
	...
	{
#ifdef VAR_DEBUG
		messageLogf(F("    Invalid variable name"));
#endif
...
#ifdef VAR_DEBUG
	messageLogf(F("Creating variable"));
#endif
...
parseOperandResult parseOperand(int * result)
{
	...
	{
#ifdef VAR_DEBUG
		messageLogf(F("    Getting variable operand"));
#endif
		// its a variable
		int position;
...
#ifdef VAR_DEBUG
	messageLogf(F("setting variable"));
...
#ifdef VAR_DEBUG
		messageLogf(F("Variable not found"));
#endif
